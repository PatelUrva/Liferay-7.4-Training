...
public class EmployeeTable extends BaseTable<EmployeeTable> {
	...
	public final Column<EmployeeTable, String> employeeMobile = createColumn(
		"employeeMobile", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<EmployeeTable, String> employeeEmail = createColumn(
		"employeeEmail", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
