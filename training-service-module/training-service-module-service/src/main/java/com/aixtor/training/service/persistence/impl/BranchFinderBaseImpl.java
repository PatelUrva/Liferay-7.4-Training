 ...
 * @generated
 */
public abstract class BranchFinderBaseImpl extends BasePersistenceImpl<Branch> {

	public BranchFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return branchPersistence.getBadColumnNames();
	}
