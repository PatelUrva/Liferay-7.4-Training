...
import com.aixtor.training.model.CityTable;
import com.aixtor.training.model.impl.CityImpl;
import com.aixtor.training.model.impl.CityModelImpl;
import com.aixtor.training.service.persistence.CityPersistence;
import com.aixtor.training.service.persistence.CityUtil;
...
public class CityPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindBycityName;
	private FinderPath _finderPathWithoutPaginationFindBycityName;
	private FinderPath _finderPathCountBycityName;

	/**
	 * Returns all the cities where cityName = &#63;.
	 *
	...
	public List<City> findBycityName(String cityName) {
		return findBycityName(
			cityName, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the cities where cityName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CityModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<City> findBycityName(String cityName, int start, int end) {
		return findBycityName(cityName, start, end, null);
	}

	/**
	 * Returns an ordered range of all the cities where cityName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CityModelImpl</code>.
	 * </p>
	...
	public List<City> findBycityName(
		...
		return findBycityName(cityName, start, end, orderByComparator, true);
	}
	...
	public List<City> findBycityName(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBycityName;
				finderArgs = new Object[] {cityName};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBycityName;
		...
		if (list == null) {
			...
			if (cityName.isEmpty()) {
				sb.append(_FINDER_COLUMN_CITYNAME_CITYNAME_3);
			}
			else {
				bindCityName = true;

				sb.append(_FINDER_COLUMN_CITYNAME_CITYNAME_2);
			}
	...
	/**
	 * Returns the first city in the ordered set where cityName = &#63;.
	 *
	 * @param cityName the city name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching city
	 ...
	 */
	@Override
	public City findBycityName_First(
			String cityName, OrderByComparator<City> orderByComparator)
		throws NoSuchCityException {

		City city = fetchBycityName_First(cityName, orderByComparator);
	 ...
	 */
	@Override
	public City fetchBycityName_First(
		String cityName, OrderByComparator<City> orderByComparator) {

		List<City> list = findBycityName(cityName, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last city in the ordered set where cityName = &#63;.
	 *
	 * @param cityName the city name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching city
	 ...
	 */
	@Override
	public City findBycityName_Last(
			String cityName, OrderByComparator<City> orderByComparator)
		throws NoSuchCityException {

		City city = fetchBycityName_Last(cityName, orderByComparator);
	 ...
	 */
	@Override
	public City fetchBycityName_Last(
		String cityName, OrderByComparator<City> orderByComparator) {
		...
		List<City> list = findBycityName(
			cityName, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the cities before and after the current city in the ordered set where cityName = &#63;.
	 *
	 * @param cityId the primary key of the current city
	 * @param cityName the city name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public City[] findBycityName_PrevAndNext(
		...
		try {
			...
			array[0] = getBycityName_PrevAndNext(
				session, city, cityName, orderByComparator, true);

			array[1] = city;

			array[2] = getBycityName_PrevAndNext(
				session, city, cityName, orderByComparator, false);
	...
	protected City getBycityName_PrevAndNext(
		Session session, City city, String cityName,
		OrderByComparator<City> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the cities where cityName = &#63; from the database.
	 *
	 * @param cityName the city name
	 */
	@Override
	...
	public int countBycityName(String cityName) {
		...
		FinderPath finderPath = _finderPathCountBycityName;
	...
	private static final String _FINDER_COLUMN_CITYNAME_CITYNAME_2 =
		"city.cityName = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindBycityName = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBycityName",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"cityName"}, true);

		_finderPathWithoutPaginationFindBycityName = new FinderPath(
